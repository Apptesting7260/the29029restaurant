class ButtonmenuModel {
  ...
  ButtonmenuModel.fromJson(Map<String, dynamic> json){
    restaurantMenuCategory = List.from(json['restaurant_menu_category']).map((e)=>RestaurantMenuCategory.fromJson(e)).toList();
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['restaurant_menu_category'] = restaurantMenuCategory!.map((e)=>e.toJson()).toList();
    return _data;
  }
}
