    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
            ...
            child: Obx(() {
          switch (past_controller.rxRequestStatus.value) {
            case Status.LOADING:
            ...
            case Status.ERROR:
              if (past_controller.error.value == 'No internet') {
            ...
            case Status.COMPLETED:
              return ListView.builder(
                ...
                itemCount:
                    past_controller.userList.value.bookingDetails!.length,
                  ...
                  return Column(
                    children: [
                      ExpansionTileCard(
                        ...
                        subtitle: Text(
                          past_controller
                              .userList.value.bookingDetails![index].bookingId
                              .toString(),
                          // '49294',
                          textAlign: TextAlign.start,
                          style: Theme.of(context)
                            ...
                            child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      past_controller.userList.value
                                    ...
                                    Text(
                                      past_controller.userList.value
                                          .bookingDetails![index].bookingDate
                                          .toString(),
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyLarge
                                    ...
                                    Text(
                                      past_controller.userList.value
                                          .bookingDetails![index].bookingTime
                                          .toString(),
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyLarge
