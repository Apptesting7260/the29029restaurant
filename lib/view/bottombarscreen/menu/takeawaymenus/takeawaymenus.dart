                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: bbuttom_controller.userList.value
                                  .takeAwayMenu!.length,
                                  ...
                                  Padding(padding: EdgeInsets.only(right: 5),
                                    child:
                                        GestureDetector(onTap: (){
                                          ...
                                          Buttomonpressslug=bbuttom_controller.userList.value
                                              .takeAwayMenu![index].categoryChildSlug
                                              .toString();
                                          buttomscreen_controlle.userList.value.categoryTitle='';
                                          buttomscreen_controlle.userList.value.partyMainMenuDetails!.clear();
                                        ...
                                        child:Container(
                                          ...
                                          child: Text(
                                            bbuttom_controller.userList.value
                                                .takeAwayMenu![index].categoryChildMenu
                                                .toString(),
...
Obx(() => buttomscreen_controlle.userList.value == null ?CircularProgressIndicator():
!(buttomscreen_controlle.userList.value.partyMainMenuDetails!.length ==0)?
Takeawaychild2(context,buttomscreen_controlle):CircularProgressIndicator() ,
)
