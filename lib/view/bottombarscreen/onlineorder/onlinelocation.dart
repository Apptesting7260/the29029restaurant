        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: height*0.03),
                    ListTile(
                      leading:Container(
                            ...
                            child: Icon(Icons.location_on,color:Color(0xff41004C),size:25,),
                      ),
                      horizontalTitleGap:5,
                      title:Text("The 29029 Restaurant Wareham",
                      style: Theme.of(context)
                          .textTheme
                          .bodySmall
                          ?.copyWith(
                      ...
                      subtitle:Text("Sandford Rd, Sandford, Wareham BH20 7DD, United Kingdom",
                        style: Theme.of(context)
                            .textTheme
                            .bodySmall
                            ?.copyWith(
              ...
              Row(
                ...
                children: [
                  MyButton(title:"Collection",
                    ...
                    height:height*0.043 ,width:Width*0.25 ,),
                  SizedBox(width: Width*0.03),
                  MyButton(title:"Delivery",
                      txtStyle:Theme.of(context).textTheme.bodySmall?.copyWith(
                        color: choose == 2
                            ? Colors.white
                            : Color(0xff911FDA),fontFamily: GoogleFonts.outfit().fontFamily,
                      fontWeight: FontWeight.w400,fontSize: 12),
                    bgColor: choose == 2
              ...
              if(selectedonDelivery == false && selectedonCollection == false)
