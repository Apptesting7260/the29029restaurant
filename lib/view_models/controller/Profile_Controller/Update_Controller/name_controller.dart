...
class Updatename_controller extends GetxController {
  ...
  void updatename_apihit(BuildContext context) {
    loading.value = true;
    Map data = {
    ...
    print(data);
    _api.Updatenameapi(data).then((value) {
      loading.value = false;

      Get.back();

      Utils.snackBar('Success', value.updateMessage![0].status.toString());
